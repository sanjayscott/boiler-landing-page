...
function HeroSection() {
  return (
    ...
    >
      ...
      />
      <style>{`
        .v10a-hero-overlay { display: none; }
        @media (min-width: 768px) { .v10a-hero-overlay { display: block; background: linear-gradient(to bottom, rgba(255,255,255,0.92), rgba(255,255,255,0.88), rgba(255,255,255,1)); } }
        @media (min-width: 1024px) { .v10a-hero-overlay { background: linear-gradient(to bottom, rgba(255,255,255,0.75), rgba(255,255,255,0.65), rgba(255,255,255,1)); } }
        @media (min-width: 1280px) { .v10a-hero-overlay { background: linear-gradient(to bottom, rgba(255,255,255,0.55), rgba(255,255,255,0.40), rgba(255,255,255,1)); } }
        @media (min-width: 1536px) { .v10a-hero-overlay { background: linear-gradient(to bottom, rgba(255,255,255,0.40), rgba(255,255,255,0.25), rgba(255,255,255,1)); } }
      `}</style>
      <div className="v10a-hero-overlay absolute inset-0" />
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20 lg:py-28">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-2xl space-y-6">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-[1.1] tracking-tight" style={{ color: WB_BLUE }} data-testid="text-hero-headline">
            Your Old Boiler Is<br />Wasting Up To<br />&pound;300 a Year
          </h1>
