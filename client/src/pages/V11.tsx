...
function HeroSection() {
  return (
    <section className="relative w-full">
      ...
      <style>{`
        .v11-hero-overlay { display: none; }
        @media (min-width: 768px) { .v11-hero-overlay { display: block; background: linear-gradient(to bottom, rgba(255,255,255,0.92), rgba(255,255,255,0.88), rgba(255,255,255,1)); } }
        @media (min-width: 1024px) { .v11-hero-overlay { background: linear-gradient(to bottom, rgba(255,255,255,0.75), rgba(255,255,255,0.65), rgba(255,255,255,1)); } }
        @media (min-width: 1280px) { .v11-hero-overlay { background: linear-gradient(to bottom, rgba(255,255,255,0.55), rgba(255,255,255,0.40), rgba(255,255,255,1)); } }
        @media (min-width: 1536px) { .v11-hero-overlay { background: linear-gradient(to bottom, rgba(255,255,255,0.40), rgba(255,255,255,0.25), rgba(255,255,255,1)); } }
      `}</style>
      <div className="v11-hero-overlay absolute inset-0" />
    ...
    <section id="pricing" className="py-14 md:py-20 bg-white">
      <div className="container mx-auto px-4">
              ...
              <Card className={`relative overflow-hidden h-full flex flex-col ${i === 1 ? "border-2 ring-2 ring-offset-2" : "border"}`} style={i === 1 ? { borderColor: WB_GREEN, ringColor: WB_GREEN } : {}}>
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="mt-4 mb-2">
                    ...
                    <p className="text-sm text-gray-500">or from <strong>{boiler.monthly}/mo</strong> with finance*</p>
                  </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-2">
          *Finance: 11.9% APR representative, over up to 10 years. Subject to status. Credit provided by Novuna Personal Finance.
        </p>
      </div>
    </section>
  );
                ...
                <div className="p-6 md:p-8 text-center">
                  ...
                  <div className="flex items-center justify-center gap-6 mb-6">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm text-gray-500">or from <strong>{result.monthly}/mo</strong> with finance*</p>
